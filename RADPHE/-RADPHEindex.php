<?php @require_once($_SERVER['DOCUMENT_ROOT'].'/_system/_SiteEngine.php'); eval(RadpheFallBackHook);
	$_INTIN['Kernel Tracking Toggle']=1;//not implemented if dump exists or not and if less than 10mb ram used.
	$_INTIN['Dump'][__FILE__][__LINE__][]=&$_INTIN['MOD'];
	$_INTIN['Dump'][__FILE__][__LINE__][]=&$_INTIN['KERNEL'];
	$SomeVariable=__FILE__;
	$SomeVariable2=__DIR__;
	$something=array(get_defined_vars());
?>
