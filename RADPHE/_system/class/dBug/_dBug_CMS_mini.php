...
//			$value .= ', '.key($subvalue).'='.$subvalue[key($subvalue)];
//			$valueS[key($subvalue).$subvalue[key($subvalue)]] = $subvalue[key($subvalue)];
		}
//		$var_ser = serialize($valueS);
//		$value = "*CLOSURE*KEYS* Check Notice in Error Log:".$value;
		error_log($value.':'.$e,0);
